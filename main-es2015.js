...
let CharacterListComponent = class CharacterListComponent {
    constructor(characterService, utilService) {
    ...
    ngOnInit() {
        this.characterUrls.forEach(characterUrl => {
            this.subscriptions.push(this.characterService.requestCharacterByUrl(characterUrl).subscribe(character => {
...
], CharacterListComponent.prototype, "characterUrls", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], CharacterListComponent.prototype, "movieId", void 0);
